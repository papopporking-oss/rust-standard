...
cargo build --example template_ui_opencv_1_youtube --release
cargo run --example template_ui_opencv_1_youtube
*/
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let url_path = "https://www.youtube.com/watch?v=glxr822v9K4";
    show_youtube(url_path)?;
